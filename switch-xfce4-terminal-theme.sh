...
if [[ "$1" == "light" ]]; then
	...
	# ]
	THEME_FILE=$DIR/config/xfce4/terminal/terminalrc-light
else
	...
	# ]
	THEME_FILE=$DIR/config/xfce4/terminal/terminalrc-dark
fi

# do a little bit of magic so xfce4-terminal always load a fresh configuration!
rm $XFCE4_TERMINAL_FILE
cp $THEME_FILE $XFCE4_TERMINAL_FILE
ln -s -f $THEME_FILE $XFCE4_TERMINAL_FILE
